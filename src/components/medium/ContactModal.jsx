    ...
    <>
      <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 '>
        <div className='px-4 py-6'>
          <div className='max-w-[600px]  w-full m-auto h-screen md:h-[600px]  md:min-h-[600px] bg-amber-50 p-8 flex flex-col items-center relative slide-in-right'>
            ...
            <div className='flex  md:flex-row gap-2 mt-2 '>
              <a 
                ...
                <div className='flex items-center gap-2 p-2 border cursor-pointer hover:bg-dark-400/20'>
                  ...
                  <p className='text-dark-500 font-bold hidden md:block'>Facebook</p>
                </div>
              </a>
              ...
              <a 
                ...
                <div className='flex items-center gap-2 p-2 border cursor-pointer hover:bg-dark-400/20'>
                  ...
                  <p className='text-dark-500 font-bold hidden md:block'>Instagram</p>
                </div>
              </a>
            ...
            <form
              ...
              <label className='text-dark-500 ' htmlFor="">
                ...
                <textarea  
                  className='w-full text-sm md:text-lg border p-2 h-[100px] min-h-[20px] max-h-[300px]'
                  name="message" 
                  id=""></textarea>
              </label>
